...
$(document).ready(function() {
  ...
  var table = $('#example').DataTable( {
    ...
    scrollCollapse: true,
    ajax: {
      url: "api/mysql_datastore.php",
      type: "POST"
    },
    serverSide: true,
    columns: [
      { data: "datastore.name", className: "dt-body" },
      { data: "datastore.moref", className: "dt-body" },
      { data: "datastore.status", className: "dt-body" },
      { data: "datastore.capacity_bytes", className: "dt-body" },
      { data: "datastore.free_bytes", className: "dt-body" },
      { data: "datastore.uncommitted_bytes", className: "dt-body" },
      { data: "datastore.type", className: "dt-body" },
      { data: "datastore.vcenter_id", className: "dt-body" }
    ],
    select: true,
    buttons: [
      'copy', 
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-11 col-lg-offset-1 col-md-11 col-md-offset-1 col-sm-11 col-sm-offset-1 main">
          ...
          <h2 class="sub-header">Datastore Summary</h2>
